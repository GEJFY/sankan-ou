...
- **各資格の実試験フォーマット対応**:
  - CIA: 3パート (125+100+100問)、スケールドスコア600/750（250-750スケール、正答率目安70-75%）で合格
  - CISA: 5ドメイン (150問)、スケールドスコア450/800（200-800スケール、正答率目安60-65%）で合格
  - CFE: 3セクション (120+120+70問、2026年6月改訂の新フォーマット)、各セクション75%以上で合格
...
|--------|--------|----------|--------|--------|------|-----------|
| **CIA** | 公認内部監査人 | IIA | `#e94560` | 325問 (3パート) | 390分 | 600/750スケール（目安70-75%） |
| **CISA** | 公認情報システム監査人 | ISACA | `#0891b2` | 150問 (5ドメイン) | 240分 | 450/800スケール（目安60-65%） |
| **CFE** | 公認不正検査士 | ACFE | `#7c3aed` | 310問 (3セクション、2026年6月改訂) | 390分相当（セクション別受験） | 各セクション75% |
